...
public class Plateau {
	...
	private void genererCasesPlateau() {
		...
		this.cases.add(c11);
		Territoire c12 = new Territoire("Le Gué de Bruinen", ECouleurCase.rose,140,70,100,new int[] {10,50,150,450,625,750});
		this.cases.add(c12);
		BatonDeMagicien c13 = new BatonDeMagicien("Le Bâton de Gandalf");
		this.cases.add(c13);
		...
		this.cases.add(c18);
		Territoire c19 = new Territoire("La Forêt de La Lorien",ECouleurCase.orange, 180,90,100,new int[] {14,70,200,550,750,950});
		this.cases.add(c19);
		...
		this.cases.add(c26);
		Territoire c27 = new Territoire("La Forêt de Fangorn", ECouleurCase.jaune,260,130,150, new int[] {22,110,330,800,975,1150});
		this.cases.add(c27);
		Territoire c28 = new Territoire("L'Ouestfolde", ECouleurCase.jaune,260,130,150, new int[] {22,110,330,800,975,1150});
		this.cases.add(c28);
		BatonDeMagicien c29 = new BatonDeMagicien("Le Bâton de Saroumane");
		this.cases.add(c29);
		...
		this.cases.add(c38);
		CaseImpots c39 = new CaseImpots("L'Antre d'Arachnée");
		this.cases.add(c39);
