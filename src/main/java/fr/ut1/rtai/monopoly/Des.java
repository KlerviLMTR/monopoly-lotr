...
public class Des {
	...
	/**
	 * Construit une paire de des.Par défaut, lorsqu'aucun lancer n'est actif, on
	 * choisit de les initialiser a 7
	 */
	public Des() {
		this.chiffreDe1 = 7;
		this.chiffreDe2 = 7;
	...
	public int getDes() {
		return (this.chiffreDe1 + this.chiffreDe2);
	}

	public int lancerDes() {
		this.chiffreDe1 = 1 + this.rand.nextInt(6);
		this.chiffreDe1 = 1 + this.rand.nextInt(6);
